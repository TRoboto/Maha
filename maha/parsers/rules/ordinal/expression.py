...
EXPRESSION_OF_TWO_THOUSANDS = ValueExpression(2000, ALEF_LAM + "[أا]لف" + TWO_SUFFIX)
EXPRESSION_OF_MILLION = ValueExpression(1000000, ALEF_LAM + "مليون")
EXPRESSION_OF_TWO_MILLIONS = ValueExpression(2000000, ALEF_LAM + "مليون" + TWO_SUFFIX)
...
EXPRESSION_OF_TWO_BILLIONS = ValueExpression(
    2000000000, ALEF_LAM + non_capturing_group("بليون", "مليار") + TWO_SUFFIX
)
EXPRESSION_OF_TRILLION = ValueExpression(1000000000000, ALEF_LAM + "تري?ليون")
EXPRESSION_OF_TWO_TRILLIONS = ValueExpression(
    2000000000000, ALEF_LAM + "تري?ليون" + TEN_SUFFIX_SIMPLE
)
